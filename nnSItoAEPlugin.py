...
# Executed Tue Jun 11 16:20:28 UTC+0200 2013 by nono
# 
...
def XSILoadPlugin( in_reg ):
	in_reg.Author = "nono"
	in_reg.Name = "NN_SItoAEPlugin"
	in_reg.Major = 1
	in_reg.Minor = 0

	in_reg.RegisterCommand("NN_SItoAE","NN_SItoAE")
	in_reg.RegisterMenu(c.siMenuMainFileExportID,"NN_SItoAE_Menu",false,false)
...
def NN_SItoAE_Execute(  ):

	Application.LogMessage("NN_SItoAE_Execute called",c.siVerbose)
	# 
	# TODO: Put your command implementation here.
	# 
	main()

def NN_SItoAE_Menu_Init( in_ctxt ):
	oMenu = in_ctxt.Source
	oMenu.AddCommandItem("NN_SItoAE","NN_SItoAE")
	return true
...
def gui(startFrame,endFrame,fps,width,height,pixelAspect,selection):
    ...
    oLayout.AddRow()
    IN = oPSet.AddParameter3("IN", c.siInt2,0,0,10000,0)
    oLayout.AddItem("IN", "IN", c.siControlNumber)
    xsi.SetValue(IN, startFrame)
    
    OUT = oPSet.AddParameter3("OUT", c.siInt2,100,1,10000,0)
    oLayout.AddItem("OUT", "OUT", c.siControlNumber)
    xsi.SetValue(OUT, endFrame)
    
    FPS = oPSet.AddParameter3("FPS", c.siInt2,25,1,1000,0)
...
def main():
    ...
    if buttonPressed == FALSE:
        ...
        fileBrowser.InitialDirectory = xsi.GetValue("Passes.RenderOptions.ResolvedOutputDir")       
        fileBrowser.FileBaseName = scene.Name
